...
public class SoketEscritor {
    public static void main(String[] args) {
        ...
        try{
           ...
           //El número del puerto es el 12345.
        ...
        if (conexion != null) //Si hemos podido abrir el puerto.
            try{
                ...
                /*  
                Creamos un objeto PrintWriter a partir del Stream de salida del socket o canal de comunicación.
                El objeto PrintWriter, nos permitirá utilizar los métodos print y write para mandar datos al proceso que está
                ...
                */
                ...
                System.err.println("No se ha podido establecer conexión, o no ha ocurrido un fallo al escribir en el canal.");
                System.err.print(ex.toString());
            }finally{
            //Nos aseguramos de que se cierren los recursos que estamos utilizando
