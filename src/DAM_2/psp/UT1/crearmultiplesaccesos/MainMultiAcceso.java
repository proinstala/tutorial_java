...
package DAM_2.psp.UT1.crearmultiplesaccesos;
    ...
    public static void main(String[] args) {
      ...
      if (osName.toUpperCase().contains("WIN")){ //Windows
        if (args.length > 0)
            ...
            nombreFichero = "C:\\Users\\USER\\Desktop\\valor.txt";
       ...
       try{
            for (int i = 0; i <=25; i++){
                nuevoProceso = Runtime.getRuntime().exec("java -jar "+
                    "AccesoMultipleFichero.jar " + i + " "+ args[0]); //hay que pasar como argumento el nombre del fichero
